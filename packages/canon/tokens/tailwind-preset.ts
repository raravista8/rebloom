// @rebloom/canon · tokens/tailwind-preset.ts
// Tailwind preset that mirrors the semantic design tokens (tokens/theme.css).
// Consumers wire it in: tailwind.config => { presets: [require('@rebloom/canon/tokens/tailwind-preset').default] }
// Colors resolve to CSS vars so theming stays centralized (CANON_PACKAGE_TZ.md §5).
