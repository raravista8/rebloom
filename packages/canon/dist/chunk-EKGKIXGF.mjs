...
function MetroDots({ lines, size = 8 }) {
  ...
  return /* @__PURE__ */ jsx("span", { className: "pd-mdots", "aria-hidden": "true", children: ls.slice(0, 3).map((l, i) => /* @__PURE__ */ jsx("i", { style: { background: PD_METRO_LINES[l] || "#A1A2A3", width: size, height: size } }, i)) });
}
  ...
  return /* @__PURE__ */ jsxs("div", { className: "pd-mpick" + (open ? " open" : ""), ref: wrapRef, children: [
    /* @__PURE__ */ jsxs("button", { type: "button", className: "pd-mpick-btn" + (open ? " open" : "") + (label ? " has" : ""), onClick: () => setOpen((o) => !o), children: [
      ...
      label ? /* @__PURE__ */ jsxs("span", { className: "val", children: [
        (!multi || values.length === 1) && /* @__PURE__ */ jsx(Dots, { lines: labelLines, size: 9 }),
    ...
    open && /* @__PURE__ */ jsxs("div", { className: "pd-mpick-panel", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "pd-mpick-list", children: filtered.length === 0 ? /* @__PURE__ */ jsx("div", { className: "pd-mpick-empty", children: "\u0421\u0442\u0430\u043D\u0446\u0438\u044F \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u0430" }) : filtered.map((s) => /* @__PURE__ */ jsxs("button", { type: "button", className: "pd-mpick-row" + (sel(s.n) ? " on" : ""), onClick: () => {
        if (multi) {
        ...
        multi && /* @__PURE__ */ jsx("span", { className: "pd-mpick-cb" + (sel(s.n) ? " on" : ""), children: sel(s.n) && I.check({ className: "pd-i14", fill: "none", stroke: "currentColor" }) }),
        /* @__PURE__ */ jsx(Dots, { lines: s.l, size: 9 }),
        /* @__PURE__ */ jsx("span", { className: "n", children: s.n }),
