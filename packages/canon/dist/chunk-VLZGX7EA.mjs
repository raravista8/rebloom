...
function MetroDots({ lines, size = 8 }) {
  ...
  return /* @__PURE__ */ jsx("span", { className: "pd-mdots", "aria-hidden": "true", children: ls.slice(0, 3).map((l, i) => /* @__PURE__ */ jsx("i", { style: { background: typeof l === "string" && l[0] === "#" ? l : PD_METRO_LINES[l] || "#A1A2A3", width: size, height: size } }, i)) });
}
function MetroLabel({ station, lines, className, dotSize }) {
  return /* @__PURE__ */ jsxs("span", { className: "pd-metro" + (className ? " " + className : ""), children: [
    /* @__PURE__ */ jsx(MetroDots, { lines: lines || pdMetroLines(station), size: dotSize || 8 }),
    /* @__PURE__ */ jsxs("span", { className: "pd-metro-n", children: [
      "\u043C.\xA0",
      station
    ] })
  ] });
...
var Heart = ({ filled, className }) => /* @__PURE__ */ jsx(
  "svg",
  {
    ...
    children: /* @__PURE__ */ jsx("path", { d: "M12 20.3C12 20.3 3.4 14.9 3.4 8.7 3.4 6 5.5 4 8 4 9.8 4 11.3 5 12 6.3 12.7 5 14.2 4 16 4 18.5 4 20.6 6 20.6 8.7 20.6 14.9 12 20.3 12 20.3Z" })
  }
);
...
function LikeBtn({ liked: init, count: c0, big, onToggle }) {
  ...
  const [likedU, setLiked] = React2.useState(init);
  const [countU, setCount] = React2.useState(c0);
...
function Card({ d, variant, onLike }) {
  ...
  return /* @__PURE__ */ jsxs("article", { className: "pd-card pd-card--" + variant, tabIndex: 0, children: [
    /* @__PURE__ */ jsxs("div", { className: "pd-photo-wrap", style: { aspectRatio: ar }, children: [
      /* @__PURE__ */ jsx("img", { className: "pd-photo", src: d.photoUrl || pdPhotoSrc(d.photo), alt: "\u0411\u0443\u043A\u0435\u0442", loading: "lazy" }),
      /* @__PURE__ */ jsxs("div", { className: "pd-photo-top", children: [
        /* @__PURE__ */ jsx(Freshness, { kind: d.fresh }),
        /* @__PURE__ */ jsx(LikeBtn, { liked: d.liked, count: d.likes, onToggle: onLike ? (next) => onLike(d.id, next) : void 0 })
      ] }),
      d.roseLabel && /* @__PURE__ */ jsx("span", { style: { position: "absolute", left: 8, bottom: 8, background: "rgba(35,32,27,.82)", color: "#fff", fontSize: 11, fontWeight: 700, letterSpacing: ".01em", padding: "4px 9px", borderRadius: 999, backdropFilter: "blur(4px)" }, children: d.roseLabel })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "pd-card-body", children: [
      /* @__PURE__ */ jsxs("div", { className: "pd-price-row", children: [
        ...
        /* @__PURE__ */ jsxs("span", { className: "pd-size", children: [
          "\u0420\u0430\u0437\u043C\u0435\u0440 ",
          d.size
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "pd-meta", children: d.metro ? /* @__PURE__ */ jsx(MetroLabel, { station: d.metro, dotSize: 7 }) : /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "pd-seller", children: [
        /* @__PURE__ */ jsx(Avatar, { seller, size: 21 }),
        /* @__PURE__ */ jsx("span", { className: "pd-seller-n", children: seller.n }),
        hasRating ? /* @__PURE__ */ jsxs("span", { className: "pd-rating", children: [
          /* @__PURE__ */ jsx(Ic.star, { className: "pd-i13 pd-star" }),
          " ",
          seller.r.toFixed(1)
        ] }) : /* @__PURE__ */ jsx("span", { className: "pd-rating pd-rating--new", children: "\u041D\u043E\u0432\u044B\u0439" })
      ] })
    ] })
  ] });
}
...
function TopBar({ safeTop }) {
  return /* @__PURE__ */ jsxs("header", { className: "pd-topbar", style: { paddingTop: safeTop }, children: [
    /* @__PURE__ */ jsxs("div", { className: "pd-topbar-row", children: [
      /* @__PURE__ */ jsxs("span", { className: "pd-brand", children: [
        /* @__PURE__ */ jsx(Mark, { size: 21 }),
        "\u041F\u0435\u0440\u0435\u0434\u0430\u0440\u0438\u043C"
      ] }),
...
var I = {
  ...
  share: (p) => /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 24 24", ...p, children: [
    /* @__PURE__ */ jsx("circle", { cx: "6", cy: "12", r: "2.6" }),
    /* @__PURE__ */ jsx("circle", { cx: "17.5", cy: "6", r: "2.6" }),
    /* @__PURE__ */ jsx("circle", { cx: "17.5", cy: "18", r: "2.6" }),
    /* @__PURE__ */ jsx("path", { d: "m8.3 10.8 6.9-3.6M8.3 13.2l6.9 3.6" })
  ] }),
  ...
  heartline: (p) => /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", ...p, children: /* @__PURE__ */ jsx("path", { d: "M12 20.3C12 20.3 3.4 14.9 3.4 8.7 3.4 6 5.5 4 8 4 9.8 4 11.3 5 12 6.3 12.7 5 14.2 4 16 4 18.5 4 20.6 6 20.6 8.7 20.6 14.9 12 20.3 12 20.3Z" }) }),
...
var Chv = (p) => /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", ...p, fill: "none", stroke: "currentColor", strokeWidth: "1.9", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx("path", { d: "m6 9 6 6 6-6" }) });
var Srch = (p) => /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 24 24", ...p, fill: "none", stroke: "currentColor", strokeWidth: "1.9", strokeLinecap: "round", strokeLinejoin: "round", children: [
  /* @__PURE__ */ jsx("circle", { cx: "11", cy: "11", r: "7" }),
  /* @__PURE__ */ jsx("path", { d: "m20 20-3.2-3.2" })
] });
function PdMetroPicker({ cityKey = "msk", value, onChange, multi = false, values = [], onToggle, placeholder = "\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0441\u0442\u0430\u043D\u0446\u0438\u044E \u043C\u0435\u0442\u0440\u043E", options, idMode = false }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "pd-mpick" + (open ? " open" : ""), ref: wrapRef, children: [
    /* @__PURE__ */ jsxs("button", { type: "button", className: "pd-mpick-btn" + (open ? " open" : "") + (label ? " has" : ""), onClick: () => setOpen((o) => !o), children: [
      /* @__PURE__ */ jsx("span", { className: "pd-mglyph", children: "\u041C" }),
      label ? /* @__PURE__ */ jsxs("span", { className: "val", children: [
        (!multi || values.length === 1) && /* @__PURE__ */ jsx(Dots, { lines: labelDots, size: 9 }),
        multi && values.length > 1 ? label : "\u043C.\xA0" + label
      ] }) : /* @__PURE__ */ jsx("span", { className: "ph", children: placeholder }),
      /* @__PURE__ */ jsx(Chv, { className: "chev pd-i18" })
    ] }),
    open && /* @__PURE__ */ jsxs("div", { className: "pd-mpick-panel", children: [
      /* @__PURE__ */ jsxs("div", { className: "pd-mpick-search", children: [
        /* @__PURE__ */ jsx(Srch, { className: "pd-i16" }),
        /* @__PURE__ */ jsx("input", { autoFocus: true, value: q, placeholder: "\u041F\u043E\u0438\u0441\u043A \u0441\u0442\u0430\u043D\u0446\u0438\u0438", onChange: (e) => setQ(e.target.value) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "pd-mpick-list", children: filtered.length === 0 ? /* @__PURE__ */ jsx("div", { className: "pd-mpick-empty", children: "\u0421\u0442\u0430\u043D\u0446\u0438\u044F \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u0430" }) : filtered.map((s) => /* @__PURE__ */ jsxs("button", { type: "button", className: "pd-mpick-row" + (sel(s.key) ? " on" : ""), onClick: () => {
        if (multi) {
        ...
        multi && /* @__PURE__ */ jsx("span", { className: "pd-mpick-cb" + (sel(s.key) ? " on" : ""), children: sel(s.key) && I.check({ className: "pd-i14", fill: "none", stroke: "currentColor" }) }),
        /* @__PURE__ */ jsx(Dots, { lines: s.dots, size: 9 }),
        /* @__PURE__ */ jsx("span", { className: "n", children: s.name }),
        !multi && sel(s.key) && I.check({ className: "pd-i16 ck", fill: "none", stroke: "currentColor" })
      ] }, s.key)) }),
      multi && values.length > 0 && /* @__PURE__ */ jsxs("div", { className: "pd-mpick-foot", children: [
        /* @__PURE__ */ jsxs("button", { type: "button", className: "clr", onClick: () => onToggle && onToggle(null), children: [
          "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C (",
          values.length,
          ")"
        ] }),
        /* @__PURE__ */ jsx("button", { type: "button", className: "done", onClick: () => setOpen(false), children: "\u0413\u043E\u0442\u043E\u0432\u043E" })
      ] })
    ] })
  ] });
}
function PdFlowerPicker({ value = [], onChange, options }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "pd-flowerpick", children: opts.map((f) => {
    const on = value.includes(f);
    return /* @__PURE__ */ jsxs("button", { type: "button", className: "pd-fbchip" + (on ? " on" : ""), onClick: () => toggle(f), "aria-pressed": on, children: [
...
export { Avatar, BottomNav, Card, Freshness, Heart, I, Ic, LikeBtn, MetroDots, MetroLabel, PD_CITY_METRO, PD_FLOWERS, PD_FLOWER_FILTERS, PD_FRESH, PD_FRESH_META, PD_LIKED, PD_METRO, PD_METRO_INDEX, PD_METRO_LINES, PD_THEMES, PdBtn, PdBubble, PdChip, PdEmpty, PdFeed, PdField, PdFlowerPicker, PdGallery, PdInput, PdMetroPicker, PdNotice, PdOtp, PdScreen, PdSeg, PdSizeSel, PdSkelCard, PdStars, PdStepper, PdToast, SectionHead, TopBar, pdMetroLines, pdMoney };
