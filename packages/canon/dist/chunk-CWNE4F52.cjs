...
var chunkQ5PKI44D_cjs = require('./chunk-Q5PKI44D.cjs');
...
var PdCatalog = (function() {
  const Ic2 = chunk42CQIEPX_cjs.Ic, Card2 = chunk42CQIEPX_cjs.Card;
  ...
  const FLOWER_OPTS = (chunk42CQIEPX_cjs.PD_FLOWER_FILTERS || []).map((f) => [f, f]);
  const FILTERS = {
  ...
  const Header = () => /* @__PURE__ */ jsxRuntime.jsx(chunkQ5PKI44D_cjs.PdWebNav, { active: "\u041A\u0430\u0442\u0430\u043B\u043E\u0433" });
  return function PdCatalog2({ platform = "desktop" }) {
    const desk = platform === "desktop";
    const MetroPicker = chunk42CQIEPX_cjs.PdMetroPicker;
    const [f, setF] = React__default.default.useState({ price: "any", fresh: "any", flower: "any", rating: "any", size: "any" });
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "pdc-body", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("aside", { className: "pdc-side", children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "pdc-fblock", children: [
              /* @__PURE__ */ jsxRuntime.jsx("h4", { children: "\u041C\u0435\u0442\u0440\u043E" }),
              /* @__PURE__ */ jsxRuntime.jsx(MetroPicker, { cityKey: "msk", multi: true, values: metros, onToggle: toggleMetro, placeholder: "\u041B\u044E\u0431\u044B\u0435 \u0441\u0442\u0430\u043D\u0446\u0438\u0438" }),
              metros.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "pdc-metrotags", children: metros.map((m) => /* @__PURE__ */ jsxRuntime.jsxs("button", { className: "pdc-metrotag", onClick: () => toggleMetro(m), children: [
                "\u043C. ",
                m,
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "pdc-main", children: [
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "pdc-mbar", children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsxs("button", { className: "pdc-mchip" + (metros.length ? " on" : ""), onClick: () => setSheet(true), children: [
                ico(Ic2.pin, "pd-i14"),
              ...
              /* @__PURE__ */ jsxRuntime.jsx("button", { className: "pdc-mchip" + (f.fresh === "today" ? " on" : ""), onClick: () => set("fresh", f.fresh === "today" ? "any" : "today"), children: "\u0421\u0432\u0435\u0436\u0438\u0439" }),
              ["\u0420\u043E\u0437\u044B", "\u041F\u0438\u043E\u043D\u044B", "\u0422\u044E\u043B\u044C\u043F\u0430\u043D\u044B"].map((fl) => /* @__PURE__ */ jsxRuntime.jsx("button", { className: "pdc-mchip" + (f.flower === fl ? " on" : ""), onClick: () => set("flower", f.flower === fl ? "any" : fl), children: fl }, fl)),
            ...
            sheet && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "pdc-panel", children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "pdc-panel-grp", children: [
                /* @__PURE__ */ jsxRuntime.jsx("h4", { children: "\u041C\u0435\u0442\u0440\u043E" }),
                /* @__PURE__ */ jsxRuntime.jsx(MetroPicker, { cityKey: "msk", multi: true, values: metros, onToggle: toggleMetro, placeholder: "\u041B\u044E\u0431\u044B\u0435 \u0441\u0442\u0430\u043D\u0446\u0438\u0438" }),
                metros.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "pdc-metrotags", children: metros.map((m) => /* @__PURE__ */ jsxRuntime.jsxs("button", { className: "pdc-metrotag", onClick: () => toggleMetro(m), children: [
                  "\u043C. ",
              ...
              Object.entries(FILTERS).map(([k, g]) => /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "pdc-panel-grp", children: [
                /* @__PURE__ */ jsxRuntime.jsx("h4", { children: g.label }),
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "pdc-fopts", children: g.opts.map(([val, lab]) => chip(k, val, lab, k === "rating")) })
              ] }, k)),
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "pdc-toolbar", children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(SortDropdown, { sort, setSort }),
