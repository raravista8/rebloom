...
var PdWebNav = (function() {
  const Ic2 = Ic, Btn = PdBtn, Heart2 = Heart;
  ...
  const Menu = (p) => /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", ...p, fill: "none", stroke: "currentColor", strokeWidth: "1.9", strokeLinecap: "round", children: /* @__PURE__ */ jsx("path", { d: "M4 7h16M4 12h16M4 17h16" }) });
  const Close = (p) => /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", ...p, fill: "none", stroke: "currentColor", strokeWidth: "1.9", strokeLinecap: "round", children: /* @__PURE__ */ jsx("path", { d: "m6 6 12 12M18 6 6 18" }) });
  const Star = (p) => /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", ...p, fill: "currentColor", stroke: "none", children: /* @__PURE__ */ jsx("path", { d: "M12 3.5l2.6 5.3 5.9.9-4.3 4.1 1 5.8L12 17l-5.2 2.6 1-5.8L3.5 9.7l5.9-.9z" }) });
  const ChevR = (p) => /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", ...p, fill: "none", stroke: "currentColor", strokeWidth: "1.9", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx("path", { d: "m9 6 6 6-6 6" }) });
  const Shield = (p) => /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 24 24", ...p, fill: "none", stroke: "currentColor", strokeWidth: "1.9", strokeLinecap: "round", strokeLinejoin: "round", children: [
    /* @__PURE__ */ jsx("path", { d: "M12 3l7 3v5c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6l7-3Z" }),
  ...
  const Phone = (p) => /* @__PURE__ */ jsxs("svg", { viewBox: "0 0 24 24", ...p, fill: "none", stroke: "currentColor", strokeWidth: "1.9", strokeLinecap: "round", strokeLinejoin: "round", children: [
    /* @__PURE__ */ jsx("rect", { x: "7", y: "2.5", width: "10", height: "19", rx: "2.5" }),
  ...
  return function PdWebNav2({ active, authed = true, city = "\u041C\u043E\u0441\u043A\u0432\u0430", cityLoc = "\u041C\u043E\u0441\u043A\u0432\u0435", user = { n: "\u041C\u0430\u0440\u0438\u044F", r: 4.9 }, links = DEFAULT_LINKS, onPublish }) {
    ...
    return /* @__PURE__ */ jsxs(React.Fragment, { children: [
      /* @__PURE__ */ jsx("header", { className: "pdl-nav", children: /* @__PURE__ */ jsxs("div", { className: "pdl-nav-in", children: [
        /* @__PURE__ */ jsxs("a", { href: LANDING, className: "pdl-brand", style: { textDecoration: "none" }, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "pdl-navright", children: [
          ...
          authed ? /* @__PURE__ */ jsxs(React.Fragment, { children: [
            /* @__PURE__ */ jsx("button", { className: "pdl-nav-icon pdl-nav-fav", "aria-label": "\u0418\u0437\u0431\u0440\u0430\u043D\u043D\u043E\u0435", children: /* @__PURE__ */ jsx(Heart2, { className: "pd-i20" }) }),
            /* @__PURE__ */ jsx("button", { className: "pdl-nav-ava", "aria-label": "\u041F\u0440\u043E\u0444\u0438\u043B\u044C", children: initial })
          ] }) : /* @__PURE__ */ jsx("a", { className: "pdl-nav-login", href: LANDING + "#login", children: "\u0412\u043E\u0439\u0442\u0438" }),
          /* @__PURE__ */ jsx("span", { className: "pdl-nav-cta", children: /* @__PURE__ */ jsx(Btn, { variant: "primary", icon: Ic2 && Ic2.plus, onClick: onPublish, children: "\u041E\u043F\u0443\u0431\u043B\u0438\u043A\u043E\u0432\u0430\u0442\u044C \u0431\u0443\u043A\u0435\u0442" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "pdl-drawer" + (menu ? " open" : ""), "aria-hidden": !menu, children: [
        /* @__PURE__ */ jsx("div", { className: "pdl-drawer-scrim", onClick: close }),
        /* @__PURE__ */ jsxs("aside", { className: "pdl-drawer-panel", role: "dialog", "aria-modal": "true", "aria-label": "\u041C\u0435\u043D\u044E", children: [
          /* @__PURE__ */ jsxs("header", { className: "pdl-drawer-top", children: [
            ...
            /* @__PURE__ */ jsx("button", { className: "pdl-drawer-x", onClick: close, "aria-label": "\u0417\u0430\u043A\u0440\u044B\u0442\u044C \u043C\u0435\u043D\u044E", children: /* @__PURE__ */ jsx(Close, {}) })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "pdl-drawer-body", children: [
            authed ? /* @__PURE__ */ jsxs("a", { className: "pdl-drawer-prof", href: "#", onClick: (e) => {
              e.preventDefault();
              close();
            }, children: [
              /* @__PURE__ */ jsx("span", { className: "av", children: initial }),
              /* @__PURE__ */ jsxs("span", { className: "who", children: [
                /* @__PURE__ */ jsx("b", { children: user.n }),
            ...
            ] }) : /* @__PURE__ */ jsxs("a", { className: "pdl-drawer-prof pdl-drawer-login", href: LANDING + "#login", onClick: close, children: [
              /* @__PURE__ */ jsx("span", { className: "av", children: ico(Ic2.user || Ic2.deals, "pd-i20") }),
              /* @__PURE__ */ jsxs("span", { className: "who", children: [
                /* @__PURE__ */ jsx("b", { children: "\u0412\u043E\u0439\u0442\u0438 \u0438\u043B\u0438 \u0437\u0430\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0438\u0440\u043E\u0432\u0430\u0442\u044C\u0441\u044F" }),
                /* @__PURE__ */ jsx("span", { children: "\u0427\u0442\u043E\u0431\u044B \u043F\u0440\u043E\u0434\u0430\u0432\u0430\u0442\u044C \u0438 \u0441\u043E\u0445\u0440\u0430\u043D\u044F\u0442\u044C" })
              ] }),
              /* @__PURE__ */ jsx(ChevR, { className: "go" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "pdl-drawer-city", children: /* @__PURE__ */ jsxs("button", { className: "head", children: [
              /* @__PURE__ */ jsx("span", { className: "pin", children: ico(Ic2.pin, "pd-i18") }),
              /* @__PURE__ */ jsxs("span", { className: "tx", children: [
                /* @__PURE__ */ jsx("b", { children: city }),
                /* @__PURE__ */ jsx("span", { children: "\u0441\u0432\u0435\u0436\u0438\u0435 \u0431\u0443\u043A\u0435\u0442\u044B \u0440\u044F\u0434\u043E\u043C" })
              ] }),
              ico(Ic2.chev, "chev pd-i18")
            ] }) }),
            /* @__PURE__ */ jsx("nav", { className: "pdl-drawer-nav", children: links.map((l) => /* @__PURE__ */ jsxs("a", { className: "pdl-drawer-row" + (active === l.label ? " on" : ""), href: l.href, onClick: close, children: [
              /* @__PURE__ */ jsx("span", { className: "ic", children: /* @__PURE__ */ jsx(l.Icon, {}) }),
              /* @__PURE__ */ jsxs("span", { className: "tx", children: [
                /* @__PURE__ */ jsx("b", { children: l.label }),
                /* @__PURE__ */ jsx("span", { children: l.sub })
              ] }),
              /* @__PURE__ */ jsx(ChevR, { className: "go" })
            ] }, l.label)) })
          ] }),
          /* @__PURE__ */ jsx("footer", { className: "pdl-drawer-foot", children: /* @__PURE__ */ jsx(Btn, { variant: "primary", block: true, lg: true, icon: Ic2 && Ic2.plus, onClick: () => {
            close();
            onPublish && onPublish();
