...
var PdCatalog = (function() {
  const Ic2 = Ic, Card2 = Card, Btn = PdBtn;
  ...
  function Header({ desk }) {
    ...
    return /* @__PURE__ */ jsx("header", { className: "pdl-nav", children: /* @__PURE__ */ jsxs("div", { className: "pdl-nav-in", children: [
      /* @__PURE__ */ jsxs("a", { href: "\u041F\u0435\u0440\u0435\u0434\u0430\u0440\u0438\u043C \xB7 \u041B\u0435\u043D\u0434\u0438\u043D\u0433 peredarim.ru.html", className: "pdl-brand", style: { textDecoration: "none" }, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "pdl-navright", children: [
        /* @__PURE__ */ jsx("button", { className: "pdl-nav-icon pdc-notif", "aria-label": "\u0423\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F", children: /* @__PURE__ */ jsx(Bell, {}) }),
        /* @__PURE__ */ jsx(Btn, { variant: "primary", icon: Ic2 && Ic2.plus, children: "\u041F\u0440\u043E\u0434\u0430\u0442\u044C \u0431\u0443\u043A\u0435\u0442" })
      ] })
    ] }) });
  }
        ...
        /* @__PURE__ */ jsxs("div", { className: "pdc-body", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "pdc-main", children: [
            /* @__PURE__ */ jsxs("div", { className: "pdc-mbar", children: [
              /* @__PURE__ */ jsxs("span", { className: "pdc-mchip", children: [
              ...
              /* @__PURE__ */ jsx("button", { className: "pdc-mchip" + (f.fresh === "today" ? " on" : ""), onClick: () => set("fresh", f.fresh === "today" ? "any" : "today"), children: "\u0421\u0435\u0433\u043E\u0434\u043D\u044F" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "pdc-toolbar", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "pdc-sort", children: [
