    ...
    <Shell desk={desk} menuLinks={menuLinks}>
      <section className="pds-top">
        <div className="pds-in">
          ...
          <h1 className="pds-h1">Платите за букет, <em>только когда забрали его</em></h1>
          <p className="pds-intro">Главный страх при покупке у незнакомца — что заплатишь и останешься без букета. На «Передариме» предоплаты нет: вы договариваетесь в чате, встречаетесь рядом с домом и платите продавцу на месте — когда увидели цветы вживую.</p>
        </div>
      </section>
      ...
      <section className="pds-sec alt">
        <div className="pds-in">
          ...
          <div className="pds-safe">
            <HeartHands />
            <p><b>Не понравился букет — просто не платите.</b> Вы ничего не теряете: деньги остаются у вас, пока цветы не окажутся в руках.</p>
          </div>
        </div>
      </section>
      ...
      <section className="pds-sec">
        <div className="pds-in">
          <div className="pds-prose">
            ...
            <h3>Несколько простых правил</h3>
            <ul>
              <li>Встречайтесь в людном месте: у метро, во дворе, днём.</li>
              <li>Проверяйте букет до оплаты: свежесть, размер, состояние.</li>
              <li>Общайтесь в чате сделки, переписка остаётся в приложении.</li>
              <li>Не переводите предоплату или задаток до встречи.</li>
            </ul>
            <h3>Если что-то не так</h3>
            <ul>
              <li>Продавец не пришёл, не отдал букет или цветы не как в объявлении — вы просто не платите. Деньги не переходят, пока букет не у вас в руках, возвращать нечего.</li>
              <li>О недобросовестном продавце сообщите в поддержку: вынесем предупреждение, ограничим или заблокируем профиль, а объявление снимем.</li>
              <li>Рейтинг и отзывы остаются с продавцом и берегут следующих покупателей, поэтому быть честным выгодно.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="pds-sec alt">
        <div className="pds-in">
          ...
          <div className="pds-faq">
            <div className="pds-faqitem"><h3 className="pds-faqq">Нужно ли платить заранее?</h3><p className="pds-faqa">Нет. Предоплаты на «Передариме» нет. Вы платите продавцу при встрече, когда уже увидели и забрали букет.</p></div>
            <div className="pds-faqitem"><h3 className="pds-faqq">Как выбрать надёжного продавца?</h3><p className="pds-faqa">Смотрите рейтинг, отзывы и историю сделок. Всё общение ведите в чате сделки — так остаётся переписка.</p></div>
            <div className="pds-faqitem"><h3 className="pds-faqq">Сколько берёт сервис?</h3><p className="pds-faqa">Публикация и сделка бесплатны. «Передарим» сводит покупателя и продавца, а расчёт проходит между вами напрямую.</p></div>
            <div className="pds-faqitem"><h3 className="pds-faqq">Что делать при обмане?</h3><p className="pds-faqa">Пожалуйтесь на объявление или продавца — модерация проверит и при нарушении заблокирует. Деньги вы не теряете, ведь платите только при встрече.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="pds-sec">
        <div className="pds-in">
          <div className="pds-cta">
            <div className="tx"><h3>Заберите свежий букет за полцены</h3><p>Свежие цветы рядом с вами, оплата при встрече. Самовывоз в своём районе.</p></div>
      ...
      <section className="pds-sec" style={{ paddingTop: 8 }}>
        <div className="pds-in">
          <div className="pds-prose">
            ...
            <p>Рядом всегда есть кто-то, кому нужны свежие цветы на свидание, в подарок или просто домой — но не за магазинные деньги. Выставьте букет на «Передариме»: пара фото, район и цена в полцены. Публикация бесплатная. Вы возвращаете часть денег, а цветы достаются человеку поблизости.</p>
