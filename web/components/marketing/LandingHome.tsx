    ...
    <section className="pdl-sec" id="how">
      <div className="pdl-in">
        ...
        <div className="pdl-steps">
          <div className="pdl-step"><span className="pdl-seller-tag">продавец</span><div className="pdl-stepn">1</div><h3>Получили букет</h3><p>Вам подарили букет, он порадовал и уже не нужен.</p></div>
    ...
    <section className="pdl-sec pdl-escrow" id="safety">
      <div className="pdl-in">
        ...
        <div className="pdl-esafe">
          ...
          <p>Рейтинг и реальные отзывы показывают надёжных продавцов, а модерация убирает обманщиков. Если что-то не так, можно пожаловаться.</p>
        </div>
      </div>
    </section>
  );
